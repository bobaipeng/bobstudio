...
def upload_create_add(file, uri, headers, j):
    ...
    # # print(res)
    # print(res['data'])
    body = {"birthday": "", "cnName": str(uuidtool.uuid1()), "enName": "", "idNumber": str(uuidtool.uuid1()), "documentId": "", "imageURI": "/images/person/20221108/164/74b1929bafe3442299f8d65041affdb9.jpg", "operatePerson": "75",
            "sex": "", "personType": "", "personTag": "", "desc": "", "idType": "", "idCountry": "", "idExpiryDate": "", "privilege": "0", "expireDate": "", "phone": "", "externalUid": "", "welcomeWords": "", "externalInfo": None}
    res = requests.post(url='https://'+uri+'/PERSON/person/create',
                        headers=headers, verify=False, json=body).json()
    # print(res)
    body = {"groupIdList": [str(j)], "operatePerson": "75", "uid": res['data']}
    res = requests.post(url='https://'+uri+'/PERSON/member/addMemberToGroups',
                        headers=headers, verify=False, json=body).json()
